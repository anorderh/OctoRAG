...
import { ErrorParams } from '../../services/shared/types/error-params.js';
...
export class PaginationLimitExceededError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                `Pagination max of ${env.defaults.pagination.maxLimit} exceeded.`,
        });
    }
}
...
export class PuppeteerPageNotRecognizedError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'Attempting to navigate to the associated URL yielded an HTTP error code.',
        });
    }
}
...
export class InvalidURLFormatError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                "The resource's associated URL did not match its type's required formatting.",
        });
    }
}
...
export class FailedGitRepoDownloadError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'The .ZIP file associated w/ the requested Git repository could not be downloaded.',
        });
    }
}
...
export class CustomTimeoutError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'A server action acting as a gateway timed out.',
        });
    }
}
...
export class InvalidVectorIndexError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'The requested vector index does not exist. Please refresh the chat.',
        });
    }
}
...
export class ScrapeEntryFailedError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'The associated content scrape failed to complete.',
        });
    }
}
...
export class MissingRAGPipelineError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'The provided session ID does not have an associated pipeline.',
        });
    }
}
...
export class InvalidLibraryError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'The library specified by the provided ID could not be located.',
        });
    }
}
...
export class InvalidLibraryAuthError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'The user is not authorized to access the requested library.',
        });
    }
}
...
export class InvalidEntityError extends CustomErrorBase {
    constructor(params?: ErrorParams) {
        super({
            ...
            body:
                params?.body ??
                'The specified entity was not able to be located.',
        });
    }
}
