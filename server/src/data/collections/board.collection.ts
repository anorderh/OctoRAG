...
import { FindType } from "../utils/constants/find-type.js";
...
export const createBoardCollection : CollectionSetup = async (db: Db) => {
    await db.createCollection(CollectionId.Board, {
        validator: {
            $jsonSchema: {
                bsonType: "object",
