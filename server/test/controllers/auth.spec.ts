...
describe('Auth Controller', () => {
    describe('Register', () => {
        ...
        it('Register account', async () => {
            let res = await registerAgent.http.post(
                '/api/auth/register', {
    ...
    describe("Login", () => {
        ...
        it('Log into account', async () => {
            let res = await loginAgent.http.post(
                '/api/auth/login', {
                    username: creds.username,
                    password: creds.password
                }
    ...
    describe("Refresh", () => {
        ...
        it('Login', async () => {
            let res = await refreshAgent.http.post(
                '/api/auth/login', {
                    username: creds.username,
                    password: creds.password
                }
    ...
    describe("Account actions' verification", () => {
        ...
        describe("Change password", () => {
            let hash : string;
            it("Request", async () => {
                let res = await actionsAgent.http.post("/api/auth/request/change/password", {
                    email: creds.email
                })
                let body = res.data;
                hash = body.hash;
            ...
            it("Confirm", async () => {
                let res = await actionsAgent.http.post("/api/auth/request/change/password/confirm", {
                    hash: hash,
        ...
        describe("Change email", () => {
            ...
            it("Request", async () => {
                let res = await actionsAgent.http.post("/api/auth/request/change/email", null, {
                    headers: { 
            ...
            it("Confirm", async () => {
                let res = await actionsAgent.http.post("/api/auth/request/change/email/confirm", {
                    hash: hash,
        ...
        describe("Delete account", () => {
            ...
            it("Request", async ()  => {
                let res = await actionsAgent.http.post("/api/auth/request/deletion", null, {
                    headers: { 
                        Authorization: accessToken
                    }
                })
            ...
            it("Confirm", async () => {
                let res = await actionsAgent.http.post("/api/auth/request/deletion/confirm", {
                    hash: hash,
                }, {
                    headers: { 
                        Authorization: accessToken
            ...
            it("Fail validation", async () => {
                let res = await actionsAgent.http.post("/api/auth/request/deletion/confirm", null, {
                    headers: { 
                        Authorization: accessToken
                    }
                })
